export const translations = {
  en: {
    ...
    contact: {
      title: "Let's Talk!",
      desc: "Interested in collaborating or have questions about my work? My door is always open. Feel free to reach out via this form or the direct contacts below!",
      email: "Email",
      wa: "WhatsApp",
      formName: "Name",
      formEmail: "Email",
  ...
  id: {
    ...
    contact: {
      ...
      desc: "Tertarik untuk berkolaborasi atau punya pertanyaan seputar karya saya? Pintu diskusiku selalu terbuka. Jangan ragu untuk menghubungi lewat formulir ini atau kontak langsung di bawah!",
      email: "Email",
      wa: "WhatsApp",
      formName: "Nama",
      formEmail: "Email",
